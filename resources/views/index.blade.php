...
<div class="container-fluid">
    ...
    <div class="row">
                    ...
                    <div class="table-responsive mt-3 no-wrap">
                        <table class="table vm no-th-brd pro-of-month">
                            ...
                            <tbody>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="dashboard-template/assets/images/users/2.jpg"
        ...
        <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="up-img" style="background-image:url(dashboard-template/assets/images/big/img1.jpg)"></div>
                <div class="card-body">
